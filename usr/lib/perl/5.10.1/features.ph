...
unless(defined(&_FEATURES_H)) {
    ...
    if( &__GNUC_PREREQ (2, 7)  && defined (defined(&__OPTIMIZE__) ? &__OPTIMIZE__ : undef)  && (defined (defined(&_LIBC) ? &_LIBC : undef) || !defined (defined(&__OPTIMIZE_SIZE__) ? &__OPTIMIZE_SIZE__ : undef))  && !defined (defined(&__NO_INLINE__) ? &__NO_INLINE__ : undef)  && defined (defined(&__extern_inline) ? &__extern_inline : undef)) {
